...
def process_audio_and_classify(file_path):
    # Charger et préparer l'audio
...
demo = gr.Interface(
    ...
    outputs=["text", "text"],
    title="Transcription et Analyse de Sentiment",
    description="Téléversez un fichier audio pour obtenir sa transcription et une analyse de sentiment."
)
